...
output=$glm_inputs_deriv/MyelinMaps_BC32k.dscalar.nii
...
output=$glm_inputs_deriv/SmoothedMyelinMaps_BC32k.dscalar.nii

#Grab all inputs in 32k resolution
inputs=$(ls $dir_hcp/sub-*/MNINonLinear/*.SmoothedMyelinMap_BC.32k_fs_LR.dscalar.nii)
...
#corr thickness maps
output=$glm_inputs_deriv/corrThickness_32k.dscalar.nii
