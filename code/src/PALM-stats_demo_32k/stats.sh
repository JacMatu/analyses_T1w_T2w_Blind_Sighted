...
wb_command \
   ...
   MyelinMaps_BC32k.dscalar.nii \
    ...
    -metric CORTEX_LEFT hemi_blind01_MyelinDemo32k_VisCort_Sig_gt_Bl_L_dpv_tstat.gii \
    -metric CORTEX_RIGHT hemi_blind01_MyelinDemo32k_VisCort_Sig_gt_Bl_R_dpv_tstat.gii

    wb_command \
    -cifti-create-dense-from-template \
   MyelinMaps_BC32k.dscalar.nii \
   test_tstat.dscalar.nii \
    -metric CORTEX_LEFT hemi_blind01_SmoothedMyelinDemo32k_VisCort_Sig_gt_Bl_L_dpv_tstat.gii \
    -metric CORTEX_RIGHT hemi_blind01_SmoothedMyelinDemo32k_VisCort_Sig_gt_Bl_R_dpv_tstat.gii
