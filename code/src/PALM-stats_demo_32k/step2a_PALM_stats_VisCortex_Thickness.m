...
%%%%%%%%%% CORR THICKNESS %%%%%%%%%
%mkdir(fullfile(stats_dir,'glm_outputs','corrThickness_Demographic_32k_VisCortSVC_Blind_Gt_Sighted'));
%output_dir = fullfile(stats_dir,'glm_outputs','corrThickness_Demographic_32k_VisCortSVC_Blind_Gt_Sighted');

mkdir(fullfile(stats_dir,'glm_outputs','corrThickness_Demographic_32k_VisCortSVC_Sighted_Gt_Blind'));
output_dir = fullfile(stats_dir,'glm_outputs','corrThickness_Demographic_32k_VisCortSVC_Sighted_Gt_Blind');
