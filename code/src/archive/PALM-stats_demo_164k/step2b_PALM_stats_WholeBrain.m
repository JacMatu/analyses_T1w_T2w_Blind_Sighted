...
mkdir(fullfile(this_dir,'glm_outputs','TEST_demo_MyelinMaps_NoMask_32k'));

%% DEMOgRAPHIC MODELS

input_file = fullfile(this_dir,'glm_inputs', 'MyelinMaps_BC32k.dscalar.nii');
output_dir = fullfile(this_dir, 'glm_outputs', 'TEST_demo_MyelinMaps_NoMask_32k');
...
palm -i MyelinMaps_BC32k.dscalar.nii -d design_demo.mat -t conBlind_demo.con -n 5000 -o demo32_noMask_Bl_gt_Sig
%palm -i MyelinMaps_BC32k.dscalar.nii -d design_demo.mat -m 'Glasser_VisualCortex_R.32k_fs_LR.dscalar.nii' -t conSig_demo.con -n 5000 -o demo_Sig_gt_Bl
