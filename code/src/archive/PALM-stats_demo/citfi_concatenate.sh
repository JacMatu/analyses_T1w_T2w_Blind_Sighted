...
output='/Volumes/Slim_Reaper/Projects/analyses_T1w_T2w_Blind_Sighted/code/src/PALM-stats_demo/SmoothedMyelinMaps_BC164k.dscalar.nii'
...
#unsmoothed maps
output='/Volumes/Slim_Reaper/Projects/analyses_T1w_T2w_Blind_Sighted/code/src/PALM-stats_demo/MyelinMaps_BC164k.dscalar.nii'
dir_hcp='/Volumes/Slim_Reaper/Projects/analyses_T1w_T2w_Blind_Sighted/outputs/derivatives/hcppipelines'
...
#thickness maps
output='/Volumes/Slim_Reaper/Projects/analyses_T1w_T2w_Blind_Sighted/code/src/PALM-stats_demo/Thickness_164k.dscalar.nii'
