...
mkdir(fullfile(this_dir,'glm_outputs','demo_MyelinMapsSmoothed_VisCortSVC'));

%% DEMOgRAPHIC MODELS

input_file = fullfile(this_dir,'glm_inputs', 'SmoothedMyelinMaps_BC164k.dscalar.nii');
output_dir = fullfile(this_dir, 'glm_outputs', 'demo_MyelinMapsSmoothed_VisCortSVC');

VisCortMask_file = fullfile(this_dir, 'glm_inputs', 'JuBrain_EVCvOTC.dscalar.nii');
...
copyfile(VisCortMask_file, output_dir);

cd(output_dir);
%palm -i input_file -d design_basic -t con_basic_bl -n 5000 -corrcon -o output_dir

palm -i SmoothedMyelinMaps_BC164k.dscalar.nii -d design_demo.mat -m VisCortMask_file -t conBlind_demo.con -n 5000 -o demo_sm_Bl_gt_Sig
palm -i SmoothedMyelinMaps_BC164k.dscalar.nii -d design_demo.mat -m VisCortMask_file -t conSig_demo.con -n 5000 -o demo_sm_Sig_gt_Bl
